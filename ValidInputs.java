...
public class ValidInputs {
  ...
  ArrayList<String> loggedIn = new ArrayList<>(Arrays.asList("help","deposit","withdraw","buy","sell","show market account balance","transaction history","get stock price","get movie info","top movies","reviews","logout","exit"));
