...
public class ValidInputs {
  ...
  ArrayList<String> admin = new ArrayList<>(Arrays.asList("help", "get date", "add interest","generate monthly statement","list active customers","generate dter","generate customer report","delete transactions","logout","exit"));
